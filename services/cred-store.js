...
function getCertPath(org, user) {
    //ORG2.com/users/Admin@ORG2.com/msp/signcerts/Admin@ORG2.com-cert.pem"
...
function getPrivateKeyPath(org, user) {
    // ../crypto/crypto-config/peerOrganizations/ORG2.com/users/Admin@ORG2.com/msp/keystore/05beac9849f610ad5cc8997e5f45343ca918de78398988def3f288b60d8ee27c_sk
...
/**
 * Creates the MSP ID from the org name for 'ORG1' it will be 'ORG1MSP'
 * @param {string} org 
 */
