...
function readCertCryptogen(org, user) {
    ...
    var certPath = CRYPTO_CONFIG_PEER_ORGS + "/" + org + ".example.com/users/" + user + "@" + org + ".example.com/msp/signcerts/" + user + "@" + org + ".example.com-cert.pem"
...
function readPrivateKeyCryptogen(org, user) {
    ...
    var pkFolder = CRYPTO_CONFIG_PEER_ORGS + "/" + org + ".example.com/users/" + user + "@" + org + ".example.com/msp/keystore"
